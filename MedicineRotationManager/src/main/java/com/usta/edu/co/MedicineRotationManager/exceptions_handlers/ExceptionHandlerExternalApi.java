...
public class ExceptionHandlerExternalApi {
    ...
    public ResponseEntity<Err> manyRequestExternalApi(HttpClientErrorException.TooManyRequests exception){
        ...
        return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS).body(new Err(429, "Many request in external api", HttpStatus.TOO_MANY_REQUESTS.name()));
    }
    ...
    public ResponseEntity<Err> conflictExternalApi(HttpClientErrorException.Conflict exception){
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new Err(409, "Conflict with External api", HttpStatus.CONFLICT.name()));
    }
    ...
    public ResponseEntity<Err> notFoundExternalApi(HttpClientErrorException.NotFound exception){
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new Err(404, "Not Found external api", HttpStatus.NOT_FOUND.name()));
    }
    ...
    public ResponseEntity<Err> notAcceptable(HttpClientErrorException.NotAcceptable exception){
        ...
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE).body(new Err(406, "Not Acceptable external api", HttpStatus.NOT_ACCEPTABLE.name()));
    }
    ...
    public ResponseEntity<Err> badGateWayExternalApi(HttpServerErrorException.BadGateway exception){
        ...
        return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(new Err(502, "Bad Gateway External Api", HttpStatus.BAD_GATEWAY.name()));
    }
    ...
    public ResponseEntity<Err> gatewatTimeoutExternalApi(HttpServerErrorException.GatewayTimeout exception){
        ...
        return ResponseEntity.status(HttpStatus.GATEWAY_TIMEOUT).body(new Err(504, "Gateway Timeout External api", HttpStatus.GATEWAY_TIMEOUT.name()));
    }
    ...
    public ResponseEntity<Err> genericApiServerException(HttpServerErrorException exception){
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Err(500, "Err generic", HttpStatus.INTERNAL_SERVER_ERROR.name()));
    }

    @ExceptionHandler(RestClientException.class)
    public ResponseEntity<Err> genericApiException(RestClientException exception){
        LOG.warn("Err generic",exception);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new Err(400, "Err generic", HttpStatus.BAD_REQUEST.name()));
    }
}
